...
function Contactus() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-20 px-4 md:px-8 flex items-center justify-center">
      <div className="w-full max-w-lg bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-xl border border-slate-200/80 dark:border-slate-700/80">
        <div className="text-center mb-8">
          <span className="inline-block px-3 py-1 text-xs font-semibold uppercase tracking-wider text-emerald-700 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-950 rounded-full mb-3">
            Agronomist Support
          </span>
