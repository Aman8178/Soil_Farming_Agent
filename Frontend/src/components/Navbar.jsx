...
function Navbar() {
    ...
    return (
        <>
            <div className={`fixed top-0 left-0 right-0 navbar dark:bg-slate-900 dark:text-white flex items-center justify-between px-4 z-50 
            ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""}`}>
                <div className="navbar flex items-center justify-between px-4">
                    <div className="navbar-start flex items-center w-full lg:w-auto">
                    ...
                    <div className="navbar-end flex items-center space-x-3">
                        <div className="navbar-center hidden lg:flex">
                            <ul className="menu menu-horizontal px-1 font-2xl">
                                {navItems}
                            </ul>
                        </div>
